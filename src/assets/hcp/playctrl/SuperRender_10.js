...
;(function (e, t) {
  ...
  e.prototype.SR_DisplayFrameData = function (e, t, r) {
    ...
    var l = this.texturePosBuffer
    a.bindBuffer(a.ARRAY_BUFFER, l)
    var R = a.getAttribLocation(u, "texturePos")
    a.enableVertexAttribArray(R)
    a.vertexAttribPointer(R, 2, a.FLOAT, false, 0, 0)
    a.bindBuffer(a.ARRAY_BUFFER, null)
    a.drawArrays(a.TRIANGLE_STRIP, 0, 4)
    a.disableVertexAttribArray(s)
    a.disableVertexAttribArray(R)
    a.useProgram(null)
  }
